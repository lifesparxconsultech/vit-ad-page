...
const APPS_SCRIPT_URL =
  "https://script.google.com/macros/s/AKfycbw4ApDVIq-g7n8Lq2eWeUA1d4ePk4nh4qIAwqlFrZeWZzJq07KqZwq3DcCoqh7pXmaD/exec";
          ...
          <div className="space-y-1.5">
            ...
            <div className="relative">
              ...
              <input
                ...
                className={`w-full rounded-xl border bg-white py-3 pl-10 pr-4 text-sm text-ink-700 placeholder:text-slate-500 outline-none transition-colors focus:ring-2 focus:border-transparent ${errors.fullName
          ...
          <div className="space-y-1.5">
            ...
            <div className="relative">
              ...
              <input
                ...
                className={`w-full rounded-xl border bg-white py-3 pl-12 pr-4 text-sm text-ink-700 placeholder:text-slate-500 outline-none transition-colors focus:ring-2 focus:border-transparent ${errors.phone
                    ? "border-red-400 focus:ring-red-400"
                    : "border-transparent focus:ring-gold-500"
                  }`}
              />
          ...
          <div className="space-y-1.5">
            ...
            <div className="relative">
              <select
                ...
                className={`w-full rounded-xl border bg-white py-3 px-4 text-sm text-ink-700 outline-none transition-colors focus:ring-2 focus:border-transparent ${errors.course
                    ? "border-red-400 focus:ring-red-400"
                    : "border-transparent focus:ring-gold-500"
                  }`}
              >
            ...
            {errors.course && (
              <p className="text-xs text-red-300">{errors.course}</p>
            )}
          </div>
          ...
          <div className="space-y-1.5">
            ...
            <div className="relative">
              ...
              <input
                ...
                className={`w-full rounded-xl border bg-white py-3 pl-10 pr-4 text-sm text-ink-700 placeholder:text-slate-500 outline-none transition-colors focus:ring-2 focus:border-transparent ${errors.email
                    ? "border-red-400 focus:ring-red-400"
                    : "border-transparent focus:ring-gold-500"
                  }`}
              />
